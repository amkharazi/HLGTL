...
if __name__ == '__main__':
    ...
    # Set up the transforms (can remain constant across seeds)
    image_size = 192
    ...
    for seed_id in range(total_seeds):
        ...
        # 2. Re-initialize Dataloaders (Ensures shuffling is determined by the new seed)
        ...
        if seed_id == 0: # Only print this once to reduce clutter
        ...
        # (Updated to accept model and optimizer as arguments for safety)
        ...
        # 6. Set up the directories to save the results for THIS seed
        TEST_ID = f'TEST_ID003_SEED_{seed_id}'
