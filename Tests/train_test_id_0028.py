...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        ax.set_title(f'Train Accuracy Trl Model On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ...
        plt.tight_layout()
        plt.savefig('images/new_train_test_id_0028.png', dpi=300)
