...
# --- تنظیمات مدل‌های MNIST (بدون سایه) ---
MODELS_CONFIG = {
...
# تنظیمات متریک‌ها (تیترها برای MNIST)
METRICS_CONFIG = {
    'Train_Accuracy': {
...
def get_model_mean_data(metric_key, seed_prefix):
    ...
    # محاسبه میانگین (بدون نیاز به انحراف معیار)
...
# ==========================================
# 3. تابع رسم نمودار مقایسه‌ای (بدون سایه)
# ==========================================
def plot_comparison(metric_key, range_type):
    ...
    for seed_prefix, model_info in MODELS_CONFIG.items():
        ...
        # 4. رسم خط (بدون سایه fill_between)
...
if __name__ == "__main__":
    print(f"--- Generating Comparison Plots (No Shadow) for MNIST ---")
    ...
    print("\n--- All MNIST Comparison Plots Created! ---")