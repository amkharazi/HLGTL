...
if __name__ == '__main__':
    ...
    # --- MAIN LOOP FOR 10 SEEDS ---
    total_seeds = 10
    
    for seed_id in range(total_seeds):
        print(f"\n{'='*20} STARTING RUN FOR A NEW SEED ID {seed_id} {'='*20}")
        ...
        new_classifier = nn.Sequential(
            ...
            tltorch.TRL(input_shape=(2,2,2,1024,3,3), output_shape=(200), factorization='Tucker', rank=(1,1,1,100,1,1,100)),
        )
        ...
        TEST_ID = f'TEST_ID0032_SEED_V2_{seed_id}'
