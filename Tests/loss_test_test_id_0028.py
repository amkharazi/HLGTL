...
def get_test_loss(folder_name):
    """
    خواندن Test Loss از فایل گزارش
    """
    ...
    try:
        with open(file_path, 'r') as f:
            content = f.read()
            # --- تغییر: جستجو برای مقدار loss در خطوط Test epoch ---
...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        ax.set_title(f'Test Loss Trl Model On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ax.set_xlabel('Epochs', fontsize=12)
        ax.set_ylabel('Test Loss', fontsize=12)
        ax.legend(loc='upper right') # لجند بالا سمت راست برای نمودار نزولی Loss بهتر است
        ...
        if ylim_bottom < 0: ylim_bottom = 0 # Loss منفی نداریم
        ...
        # نام فایل خروجی
        save_path = 'images/test_loss_test_id_0028.png'
