...
# Test ResNet50 model on CIFAR100 dataset
# New Classifier - Our Methods
# Optimizer Adam - Default
# No Scheduler
# CIFAR100 dataset -> (3, 192, 192) 
# Pretrained
# Trasfer Learning
...
from Utils.Cifar100_loader import get_cifar100_dataloaders
...
if __name__ == '__main__':
    ...
    new_classifier = nn.Sequential(
        ...
        tltorch.TRL(input_shape=(2,2,2,1024,3,3), output_shape=(100), factorization='Tucker', rank=(1,1,1,100,1,1,100)),
    )
