...
# Test ResNet101 model on CIFAR10 dataset
...
if __name__ == '__main__':
    ...
    new_classifier = nn.Sequential(
        reshape(split=[16,2,2], map_type=2, device=device),
        tltorch.TRL(input_shape=(16,2,2,128,3,3), output_shape=(10), factorization='Tucker', rank=(4,1,1,10,1,1,4)),
    )
