...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        ax.set_title(f'Test Accuracy Our Method On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ...
        plt.tight_layout()
        plt.savefig('images/new_test_test_id_0032.png', dpi=300)
        print("\nPlot saved as 'new_test_test_id_0032.png'")
        plt.show()
