...
if __name__ == '__main__':
    ...
    new_classifier = nn.Sequential(
        reshape(split=[8,2,2], map_type=2, device=device),
        tltorch.TCL(input_shape=(8,2,2,16,3,3), rank=(2,1,1,10,2,2)),
        tltorch.TRL(input_shape=(2,1,1,10,2,2), output_shape=(10), factorization='Tucker', rank=(1,1,1,5,1,1,10)),
    )
