...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        # رنگ نمودار تست (نارنجی برای تمایز با آبی)
        ...
        if y_range == 0: y_range = 1.0 # جلوگیری از خطا در صورت ثابت بودن اعداد
        ...
        ax.set_title(f'Test Accuracy Trl Model On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ...
        plt.tight_layout()
        # نام فایل خروجی
        plt.savefig('images/new_test_test_id_0028.png', dpi=300)
        print("\nPlot saved as 'new_test_test_id_0028.png'")
        plt.show()
