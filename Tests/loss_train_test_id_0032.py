...
# ==========================================
RESULTS_DIR = '../results'
SEED_PREFIX = 'TEST_ID0032'  # Our Method
...
def get_train_loss(folder_name):
    """
    خواندن Train Loss از فایل گزارش
    """
    ...
    try:
        with open(file_path, 'r') as f:
            content = f.read()
            # --- تغییر: جستجو برای مقدار loss در خطوط Train epoch ---
...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        ax.set_title(f'Train Loss Our Method On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ax.set_xlabel('Epochs', fontsize=12)
        ax.set_ylabel('Train Loss', fontsize=12)
        ax.legend(loc='upper right') # لجند بالا راست
        ...
        # ساخت پوشه images اگر نیست
        os.makedirs('images', exist_ok=True)

        # نام فایل خروجی
        save_path = 'images/train_loss_test_id_0032.png'
