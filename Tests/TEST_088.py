...
if __name__ == '__main__':
    ...
    new_classifier = nn.Sequential(
        ...
        nn.Dropout(p=0.5),
        tltorch.TCL(input_shape=(2,2,2,256,3,3), rank=(2,2,2,256,1,1)),
        tltorch.TRL(input_shape=(2,2,2,256,1,1), output_shape=(200), factorization='Tucker', rank=(1,1,1,256,1,1,200)),
    )
