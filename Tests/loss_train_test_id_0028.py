...
# ==========================================
RESULTS_DIR = '../results'
SEED_PREFIX = 'TEST_ID0028'  # مدل TRL
...
if __name__ == "__main__":
    ...
    if len(all_seeds_data) > 0:
        ...
        ax.set_title(f'Train Loss Trl Model On Tiny Image Net Dataset', fontsize=14, fontweight='bold')
        ...
        # نام فایل خروجی
        save_path = 'images/train_loss_test_id_0028.png'
