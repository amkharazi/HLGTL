...
\end{align}
which is ideally less than equation \ref{eq:tcl-parmeter} (Appendix \ref{proof-1}).
...
\end{align} 
which is ideally less than equation \ref{eq:trl-parmeter} (Appendix \ref{proof-2}).
...
\label{sec:experiments}
	...
	\begin{table}
		...
		\begin{tabular}{c c c c c c}
			...
			\midrule
			\multirow{8}{*}{MNIST} & \multirow{4}{*}{Resnet50} &   &   & 737,290 & 97.25 \\ 
			& & (50,3,3,3) &   & 103,816 & 96.49 \\ 
			& & (1,1,1,20,1,1,4) & (2,2,2)\(^A\) & 20,612 & \textbf{98.56} \\ 
			& & (4,1,1,20,1,1,10) & (16,2,2)\(^C\) & 3,534 & 98.12 \\ 
			\cmidrule(lr){2-6}
			& \multirow{4}{*}{Resnet101} &   &   & 737,290 & \textbf{98.58} \\ 
			& & (50,3,3,3) &   & 103,816 & 97.42 \\ 
			& & (1,1,1,20,1,1,4) & (2,2,2)\(^C\) & 20,612 & 98.24 \\ 
			& & (4,1,1,20,1,1,10) & (16,2,2)\(^A\) & 3,534 & 98.40 \\ 
			\midrule
			\multirow{8}{*}{CIFAR10} & \multirow{4}{*}{Resnet50} &   &   & 737,290 & 90.71 \\ 
			& & (50,3,3,3) &   & 103,816 & 90.41 \\ 
			& & (1,1,1,100,1,1,10) & (2,2,2)\(^C\) & 103,512 & \textbf{92.58} \\ 
			& & (4,1,1,10,1,1,4) & (16,2,2)\(^A\) & 1,386 & 90.44 \\ 
			\cmidrule(lr){2-6}
			& \multirow{4}{*}{Resnet101} &   &   & 737,290 & \textbf{92.67} \\ 
	...
	\begin{table}
		...
		\begin{tabular}{c c c c c c}
			...
			(6,2,2,64,3,3) & (4,2,2,64,1,1,200) & (8,2,2)\(^C\) & 253,104 & 68.29 & \textbf{88.34} \\ 
			\bottomrule
		\end{tabular}
	\end{table}
...
Therefore, with ideal splits, $\sum_{i=1}^{N} k_i \times \frac{I_i}{L_i} \leq \beta$ , inequality \ref{eq:proof-1-15} holds. The rest of the proof is similar to \textit{\textbf{ideal}} situation.
\end{proof} 
 
\begin{proof}[\textbf{semi ideal}]
	We prove that given some ideal ranks, inequality \ref{eq:proof-1-14} holds.
...
Therefore, with ideal splits as long as the existed semi ideal ranks follow inequality \ref{eq:proof-1-27}, inequality \ref{eq:proof-1-15} holds. The rest of the proof is similar to \textit{\textbf{ideal}} situation.
\end{proof}
...
Therefore, with ideal ranks, $\forall i \hspace{2mm}\hat{R}_i \leq R_i$ and $\sum_{i=0}^{N} r_iL_i \leq \alpha_1$, inequality \ref{eq:proof-2-29} holds.

Assume $\forall i\hspace{2mm}\prod_{i=1}^{N}r_i \prod_{i=1}\hat{R}_i > 
...
Therefore, with ideal ranks and splits, inequality \ref{eq:proof-2-29} holds using \ref{eq:proof-2-37}.
\end{proof}

\begin{proof}[\textbf{semi ideal}]
	We prove that given semi ideal ranks, inequality \ref{eq:proof-2-29} holds.
	
	Assume $\forall i \hspace{2mm}\hat{R}_i > R_i$, which is equivalent to  
...
\end{align}
	...
	Therefore, given the assumption and the inequality \ref{eq:proof-2-41}, with ideal splits, \ref{eq:proof-2-39} holds. The rest of the proof is similar to \textbf{\textit{ideal}} situation.
\end{proof}
