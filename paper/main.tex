...
\begin{align}
	\label{eq:unfolding}
	&(i_0, \dots, i_n,\dots,i_N) \longrightarrow (i_n,r)\\
	&\text{where } r = \sum_{\substack{p=0 \\ p\neq n}}^{N} I_p \prod_{\substack{l=p+1 \\ l\neq n}}^{N} I_l
\end{align}
...
\begin{align}
	...
	&(i_1,\dots,i_N) \longrightarrow r\\
	&\text{where } r = \sum_{\substack{p=0}}^{N} I_p \prod_{\substack{l=p+1}}^{N} I_l
\end{align}
