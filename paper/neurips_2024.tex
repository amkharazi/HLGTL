...
\label{subsubsec:tcl}
\textit{Tensor Contraction Layer} (TCL) \cite{r1} is a form of feature extraction and could also be used for embedding. The prime idea behind TCL is Tucker decomposition; Via multiplying matrices to each mode of the input tensor, we can obtain a denser tensor . Figure \ref{fig:2-3} demonstrate the TCL process on a 3-order tensor. 
...
\begin{align}
	...
	\bar{\hat{\mathcal{X}}} = \hat{\mathcal{X}}_{[0]} \in \mathbb{R}^{S_0\times R} \hspace{10mm}\textbf{and}\hspace{10mm} \bar{\hat{\mathcal{G}}} = \hat{\mathcal{G}}_{[N+1]} \in \mathbb{R}^{O\times R}
\end{align}
...
\begin{align}
	...
	\bar{\tilde{\mathcal{X}}} = \hat{\tilde{\mathcal{X}}}_{[0]} \in \mathbb{R}^{S_0\times R^\prime} \hspace{10mm}\textbf{and}\hspace{10mm} \bar{\tilde{\mathcal{G}}} = \hat{\tilde{\mathcal{G}}}_{[N+1]} \in \mathbb{R}^{O\times R^\prime}
\end{align}
...
\begin{align}
	...
	\Omega^\prime = \left\{\bar{\tilde{\mathcal{X}}} \bar{\tilde{\mathcal{G}}}^T | \textbf{conditions \ref{eq:subspace-tcl-62}, \ref{eq:subspace-tcl-61}}\right\}
\end{align}
