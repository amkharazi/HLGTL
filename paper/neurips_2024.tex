...
\begin{figure}
	...
	\caption{
		Our framework performs better with similar ranks compared to standard TRL or original FC. Ground Truth is the weight tensor (2-order tensor) displayed as an image, other modules tried to estimate $\mathcal{W}$ using noisy data. 
	}
	\label{fig:ablation}
\end{figure}
